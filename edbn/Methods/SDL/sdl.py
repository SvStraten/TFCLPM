import sys
sys.path.append('//Users/sjoerdvanstraten/Library/CloudStorage/OneDrive-TUEindhoven/EINDHOVEN UNIVERSITY OF TECHNOLOGY - YEAR 7/TFCLPM/TFCLPM-main')
...
def learn_model(log, attributes, epochs, early_stop):
    ...
    outfile = 'tmp/model_{epoch:03d}-{val_loss:.2f}.keras'
